...
<head>
    ...
    <title>Holcim · Registrar Camión</title>
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Captura una nueva unidad de la flota con sus datos operativos y de mantenimiento desde una vista optimizada para escritorio y móvil.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    <div class="label">Estado inicial</div>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Registra nuevas unidades para fortalecer el control de flota, disponibilidad operativa y programación de mantenimiento.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                <div class="hero-title">Registro de unidad</div>
                <div class="hero-value">Camión</div>
                <div class="hero-sub">Completa la información principal de la unidad para integrarla al módulo logístico del sistema.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Estado sugerido</div>
                <div class="hero-value">Disponible</div>
                <div class="hero-sub">Configuración inicial recomendada al dar de alta una unidad.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Campo crítico</div>
                <div class="hero-value">Placa</div>
                <div class="hero-sub">Identificador principal para control, despacho y seguimiento.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Capacidad</div>
                <div class="hero-value">m³</div>
                <div class="hero-sub">Define la capacidad operativa de carga de la unidad.</div>
            </div>
        </section>
        ...
        <div class="breadcrumb">
            ...
            <a href="listar.php"><i class="fas fa-truck-moving"></i> Camiones</a>
            <span class="separator"><i class="fas fa-chevron-right"></i></span>
            <span><i class="fas fa-plus-circle"></i> Nuevo camión</span>
        </div>
        ...
        <div class="info-banner">
            ...
            <div>
                <div class="info-title">Registro de nueva unidad</div>
                <div class="info-text">Captura placa, capacidad, estado, condición y mantenimiento estimado para agregar el camión a la flota operativa.</div>
            </div>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-badge">Clave</div>
                </div>
                <div class="kpi-label">Identificación</div>
                <div class="kpi-value">Placa</div>
                <div class="kpi-foot">Campo obligatorio para identificar la unidad dentro del sistema.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-cube"></i></div>
                    <div class="kpi-badge">Carga</div>
                </div>
                <div class="kpi-label">Capacidad</div>
                <div class="kpi-value">m³</div>
                <div class="kpi-foot">Permite planificar correctamente volumen y asignación de despacho.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Disponible, Ocupado o Mantenimiento según situación actual.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Ayuda a controlar revisión técnica y disponibilidad futura.</div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Completa los datos obligatorios y opcionales para dar de alta la unidad en la flota.</p>
                </div>
            </div>

            <div class="form-panel">
                <form action="guardar.php" method="POST" id="camionForm" novalidate>
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-tag left-icon"></i>
                                <input
                                    type="text"
                                    id="placa"
                                    name="placa"
                            ...
                            <div class="field-error" id="error-placa">
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Año o modelo de referencia de la unidad.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input
                                    ...
                                    min="0.01"
                                    required
                                    class="with-right-icon"
                                    placeholder="0.00"
                                >
                                <i class="fas fa-cube right-icon"></i>
                            </div>
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                La capacidad debe ser mayor a 0.
                            </div>
                            <div class="field-error" id="error-capacidad">
                                <i class="fas fa-circle-exclamation"></i>
                                La capacidad debe ser mayor a 0.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Estado actual de la unidad dentro de la operación.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Estado físico general estimado de la unidad.
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="prox_mantenimiento">
                                <i class="fas fa-calendar-days"></i>
                                Próximo mantenimiento
                            </label>
                            <div class="input-wrap">
                                <i class="fas fa-screwdriver-wrench left-icon"></i>
                                <input
                                    type="date"
                                    id="prox_mantenimiento"
                                    name="prox_mantenimiento"
                                    min="<?php echo date('Y-m-d'); ?>"
                                >
                            </div>
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Fecha estimada del siguiente mantenimiento preventivo.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-file-lines left-icon"></i>
                                <input
                                    type="text"
                                    id="observaciones"
                                    name="observaciones"
...
<script>
    ...
    if (placaInput) {
        placaInput.addEventListener('input', function () {
            ...
            setError(this, errorPlaca, false);
        });
    }
    ...
    if (capacidadInput) {
        capacidadInput.addEventListener('input', function () {
            setError(this, errorCapacidad, false);
        });
    }
    ...
    function validarFormulario() {
        ...
        if (placa.length < 3) {
            setError(placaInput, errorPlaca, true);
            if (valido) placaInput.focus();
            valido = false;
        } else {
            setError(placaInput, errorPlaca, false);
        }

        if (isNaN(capacidad) || capacidad <= 0) {
            setError(capacidadInput, errorCapacidad, true);
            if (valido) capacidadInput.focus();
            valido = false;
        } else {
            setError(capacidadInput, errorCapacidad, false);
        }
    ...
    if (camionForm) {
        camionForm.addEventListener('submit', function (e) {
            if (!validarFormulario()) {
                e.preventDefault();
                showToast(
                    'Formulario incompleto',
                    'Revisa los campos obligatorios antes de guardar la unidad.',
                    'warning',
                    3200
                );
                return;
            ...
            showToast(
                'Validación correcta',
                'Se enviará el registro del camión.',
                'success',
                1800
            );
        });
    ...
    window.addEventListener('load', () => {
        showToast(
            'Formulario listo',
            'Captura los datos de la nueva unidad y guarda el registro cuando esté completo.',
            'info',
            3200
        );
    });
