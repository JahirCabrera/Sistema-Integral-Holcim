...
$totalCargas = count($data);
$totalCantidad = 0;
$destinosUnicos = [];
$materialesUnicos = [];

foreach ($data as $c) {
    $totalCantidad += floatval($c["cantidad"] ?? 0);

    $destino = trim($c["destino"] ?? "");
    if ($destino !== "") {
        $destinosUnicos[$destino] = true;
    }

    $material = trim($c["material"] ?? "");
    if ($material !== "") {
        $materialesUnicos[$material] = true;
    }
}

$totalDestinos = count($destinosUnicos);
$totalMateriales = count($materialesUnicos);
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Consulta y administra el detalle de materiales cargados, cantidades, camiones y destinos en una vista moderna.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    ...
                    <div class="value"><?php echo $totalCargas; ?></div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Consulta los registros de carga, revisa cantidades totales, destinos y materiales utilizados en la operación.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value"><?php echo $totalCargas; ?></div>
                <div class="hero-sub">Cargas registradas actualmente dentro del módulo operativo.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Cantidad total</div>
                <div class="hero-value"><?php echo formatearCantidad($totalCantidad); ?></div>
                <div class="hero-sub">Suma acumulada de cantidades registradas en las cargas actuales.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Destinos únicos</div>
                <div class="hero-value"><?php echo $totalDestinos; ?></div>
                <div class="hero-sub">Cantidad de destinos diferentes incluidos en los registros.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Materiales únicos</div>
                <div class="hero-value"><?php echo $totalMateriales; ?></div>
                <div class="hero-sub">Variedad de materiales presentes en las cargas del sistema.</div>
            </div>
        </section>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-truck-loading"></i></div>
                    <div class="kpi-badge">Registros</div>
                </div>
                <div class="kpi-label">Total cargas</div>
                <div class="kpi-value"><?php echo $totalCargas; ?></div>
                <div class="kpi-foot">Cantidad de registros cargados actualmente en el módulo.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo formatearCantidad($totalCantidad); ?></div>
                <div class="kpi-foot">Suma de cantidades capturadas en todas las cargas registradas.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Destinos</div>
                <div class="kpi-value"><?php echo $totalDestinos; ?></div>
                <div class="kpi-foot">Número de destinos únicos asociados a las cargas actuales.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Variedad</div>
                <div class="kpi-value"><?php echo $totalMateriales; ?></div>
                <div class="kpi-foot">Cantidad de materiales distintos incluidos en el registro de cargas.</div>
            </div>
        </section>
        ...
        <div class="toolbar">
            <div class="search-group">
                ...
                <input
                    ...
                    id="searchInput"
                    class="search-input"
                    placeholder="Buscar por material, cantidad, unidad, camión, destino o fecha..."
                >
            </div>

            <a href="registrar.php" class="toolbar-btn primary">
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Consulta, edita o elimina registros de cargas desde una vista adaptable a escritorio y móvil.</p>
                </div>
            </div>
            ...
            <div class="panel">
                <?php if (!empty($data)): ?>
                    <div class="empty-search" id="emptySearchState">
                        ...
                        <p>No se encontraron cargas con ese criterio de búsqueda.</p>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($data as $i => $c): ?>
                                        <?php
                                            ...
                                            $destino = $c["destino"] ?? "";
                                            $fecha = $c["fecha"] ?? "";
                                            $searchText = strtolower(trim($material . ' ' . $cantidad . ' ' . $unidad . ' ' . $camion . ' ' . $destino . ' ' . $fecha));
                                        ?>
                                        <tr class="search-item" data-search="<?php echo htmlspecialchars($searchText); ?>">
                                            ...
                                            <td class="cantidad-cell"><?php echo htmlspecialchars($cantidad); ?></td>
                                            <td><?php echo htmlspecialchars($unidad); ?></td>
                                            <td><?php echo htmlspecialchars($camion); ?></td>
                                            <td><?php echo htmlspecialchars($destino); ?></td>
                                            <td class="fecha-cell"><?php echo htmlspecialchars($fecha); ?></td>
                                            <td class="actions-cell">
                                                <a href="editar.php?id=<?php echo $i; ?>" class="btn-action btn-edit">
                                                    <i class="fas fa-pen"></i> Editar
                                                </a>
                                                <a href="eliminar.php?id=<?php echo $i; ?>" class="btn-action btn-delete" onclick="return confirm('¿Eliminar esta carga?')">
                    ...
                    <div class="mobile-cards">
                        <?php foreach ($data as $i => $c): ?>
                            <?php
                                ...
                                $searchText = strtolower(trim($material . ' ' . $cantidad . ' ' . $unidad . ' ' . $camion . ' ' . $destino . ' ' . $fecha));
                            ?>
                            <div class="carga-card search-item" data-search="<?php echo htmlspecialchars($searchText); ?>">
                                <div class="carga-card-top">
                                    <div class="carga-card-title">
                                        <span class="id-badge">#<?php echo $i; ?></span>
                                        <div class="mobile-name"><?php echo htmlspecialchars($material); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="mobile-grid">
                                    <div class="mobile-item">
                                        ...
                                        <div class="mobile-value"><?php echo htmlspecialchars($cantidad . ' ' . $unidad); ?></div>
                                    </div>

                                    <div class="mobile-item">
                                        <div class="mobile-label">Camión</div>
                                        <div class="mobile-value"><?php echo htmlspecialchars($camion); ?></div>
                                    </div>

                                    <div class="mobile-item">
                                        <div class="mobile-label">Destino</div>
                                        <div class="mobile-value"><?php echo htmlspecialchars($destino); ?></div>
                                    </div>

                                    <div class="mobile-item">
                                        <div class="mobile-label">Fecha</div>
                                        <div class="mobile-value"><?php echo htmlspecialchars($fecha); ?></div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Comienza agregando tu primera carga al sistema.</p>
                        <a href="registrar.php" class="toolbar-btn primary" style="display:inline-flex; min-width:auto;">
                            <i class="fas fa-plus-circle"></i>
                            Nueva carga
                        </a>
                    </div>
...
<nav class="mobile-bottom-nav">
    ...
    <a href="../cargas/listar.php" class="active">
