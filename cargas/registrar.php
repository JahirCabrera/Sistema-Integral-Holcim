...
/* leer camiones - desde el archivo en /cargas */
$camionesArchivo = __DIR__ . "/camiones.json";
$camiones = [];

if (file_exists($camionesArchivo)) {
    $contenido = file_get_contents($camionesArchivo);
    if (!empty($contenido)) {
        $camionesJson = json_decode($contenido, true);
        if (is_array($camionesJson)) {
            $camiones = $camionesJson;
        }
    }
}

// Si no hay camiones, mostrar mensaje
if (empty($camiones)) {
    // Opcional: Crear archivo con datos de ejemplo
    $camionesEjemplo = [
        ["placa" => "ABC-123", "marca" => "Volvo", "modelo" => "2022"],
        ["placa" => "XYZ-789", "marca" => "Mercedes", "modelo" => "2023"]
    ];
    file_put_contents($camionesArchivo, json_encode($camionesEjemplo, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
    $camiones = $camionesEjemplo;
}
...
<head>
    ...
    <title>Holcim · Registrar Carga</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-card::before {
            ...
            inset: 0 auto 0 0;
            width: 4px;
            background: linear-gradient(180deg, var(--primary-2), var(--acento));
        }
        ...
        .section-header h3::after {
            ...
            border-radius: 999px;
            margin-top: 8px;
            background: linear-gradient(135deg, var(--acento), var(--primary-2));
        }
...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <div class="menu-group">
            <div class="menu-title">Director</div>
            <a class="nav-link" href="../index.php"><i class="fas fa-chart-pie"></i> Panel de control</a>
        ...
        <div class="menu-group">
            ...
            <a class="nav-link active" href="../cargas/listar.php"><i class="fas fa-weight-hanging"></i> Cargas</a>
        </div>
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Captura una nueva carga con material, cantidad, camión, destino y fecha desde una vista optimizada para operación.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    <div class="label">Camiones totales</div>
                    <div class="value"><?php echo $totalCamiones; ?></div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                <h2>Alta de carga</h2>
                <p>Captura los datos principales de una nueva carga para integrarla al módulo operativo y dar seguimiento a la logística.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value">Carga</div>
                <div class="hero-sub">Captura material, cantidad, unidad, camión, destino, fecha y observaciones para integrarlo al sistema.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Camiones totales</div>
                <div class="hero-value"><?php echo $totalCamiones; ?></div>
                <div class="hero-sub">Unidades registradas en el sistema (sin filtrar por estado).</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Campo clave</div>
                <div class="hero-value">Cantidad</div>
                <div class="hero-sub">Permite medir el volumen cargado y su impacto operativo.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Seguimiento</div>
                <div class="hero-value">Destino</div>
                <div class="hero-sub">Facilita el rastreo y control del movimiento logístico de la carga.</div>
            </div>
        </section>
        ...
        <div class="crumb">
            ...
            <a href="listar.php"><i class="fas fa-weight-hanging"></i> Cargas</a>
            <span class="separator"><i class="fas fa-chevron-right"></i></span>
            <span><i class="fas fa-plus"></i>Nueva carga</span>
        </div>
        ...
        <div class="info-banner">
            ...
            <div>
                <div class="info-title">Registro de carga</div>
                <div class="info-text">Completa la información principal para integrar una nueva carga al módulo operativo del sistema.</div>
            </div>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-badge">Material</div>
                </div>
                <div class="kpi-label">Campo clave</div>
                <div class="kpi-value">Material</div>
                <div class="kpi-foot">Elemento principal que se transportará en la nueva carga.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-weight-hanging"></i></div>
                    <div class="kpi-badge">Volúmenes</div>
                </div>
                <div class="kpi-label">Cantidad</div>
                <div class="kpi-value">Stock</div>
                <div class="kpi-foot">Determina el volumen o peso asociado al registro logístico.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-truck"></i></div>
                    <div class="kpi-badge">Unidad</div>
                </div>
                <div class="kpi-label">Camión</div>
                <div class="kpi-value"><?php echo $totalCamiones; ?></div>
                <div class="kpi-foot">Camiones registrados en el sistema (todos los estados).</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-map-location-dot"></i></div>
                    <div class="kpi-badge">Logística</div>
                </div>
                <div class="kpi-label">Destino</div>
                <div class="kpi-value">Ruta</div>
                <div class="kpi-foot">Permite asociar la carga a su destino de entrega o traslado.</div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Completa los campos obligatorios y opcionales para guardar la nueva carga.</p>
                </div>
            </div>

            <div class="form-panel">
                <form method="POST" id="cargaForm" novalidate>
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-cube left-icon"></i>
                            ...
                            <div class="field-error" id="error-material">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-weight-hanging left-icon"></i>
                                <input type="number" step="0.01" min="0.01" name="cantidad" id="cantidad" placeholder="Ej: 25" required>
                            </div>
                            <div class="field-error" id="error-cantidad">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-ruler-combined left-icon"></i>
                                <input type="text" name="unidad" id="unidad" placeholder="kg, ton, m3" required>
                            </div>
                            <div class="field-error" id="error-unidad">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-truck left-icon"></i>
                                <select name="camion" id="camion" required>
                                    <option value="">Seleccionar camión</option>
                                    <?php if (empty($camiones)): ?>
                                        <option value="" disabled>⚠️ No hay camiones registrados</option>
                                    <?php else: ?>
                                        <?php foreach ($camiones as $camion): ?>
                                            <?php
                                            // Construir el texto a mostrar de forma inteligente
                                            $textoMostrar = '';
                                            
                                            // Buscar PLACA en diferentes formatos
                                            ...
                                            } elseif (!empty($camion['id'])) {
                                                $textoMostrar = 'ID: ' . $camion['id'];
                                            } else {
                                                $textoMostrar = 'Camión sin placa';
                                            }
                                            
                                            // Buscar MARCA/MODELO en diferentes formatos
                                            if (!empty($camion['marca'])) {
                                                ...
                                                $textoMostrar .= ' - ' . $camion['MARCA'];
                                            } elseif (!empty($camion['modelo_marca'])) {
                                                $textoMostrar .= ' - ' . $camion['modelo_marca'];
                                            } elseif (!empty($camion['marca_modelo'])) {
                                                $textoMostrar .= ' - ' . $camion['marca_modelo'];
                                            }
                                            ?>
                            ...
                            <div class="help-text">
                                ...
                                Se muestran todos los camiones registrados (<?php echo $totalCamiones; ?> unidades disponibles).
                            </div>
                            <div class="field-error" id="error-camion">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-map-location-dot left-icon"></i>
                                <input type="text" name="destino" id="destino" placeholder="Ej: Planta Norte / Obra Centro" required>
                            </div>
                            <div class="field-error" id="error-destino">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field-error" id="error-fecha">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group col-full">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-pen left-icon"></i>
                                <input type="text" name="obs" id="obs" placeholder="Notas adicionales de la carga">
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer">
            © 2026 Holcim México · Sistema de Gestión de Cemento · Módulo de Cargas v3.0
        </div>
    </main>
</div>
...
<script>
    ...
    const errorMaterial = document.getElementById('error-material');
    const errorCantidad = document.getElementById('error-cantidad');
    const errorUnidad = document.getElementById('error-unidad');
    const errorCamion = document.getElementById('error-camion');
    ...
    function validarFormulario() {
        ...
        if (materialInput.value.trim() === '') {
            setError(materialInput, errorMaterial, true);
            if (valid) materialInput.focus();
            valid = false;
        } else {
            setError(materialInput, errorMaterial, false);
        }

        if (cantidadInput.value.trim() === '' || Number(cantidadInput.value) <= 0) {
            setError(cantidadInput, errorCantidad, true);
            if (valid) cantidadInput.focus();
            valid = false;
        } else {
            setError(cantidadInput, errorCantidad, false);
        }

        if (unidadInput.value.trim() === '') {
            setError(unidadInput, errorUnidad, true);
            if (valid) unidadInput.focus();
            valid = false;
        } else {
            setError(unidadInput, errorUnidad, false);
        }

        if (camionInput.value.trim() === '') {
            setError(camionInput, errorCamion, true);
            if (valid) camionInput.focus();
            valid = false;
        } else {
            setError(camionInput, errorCamion, false);
        }

        if (destinoInput.value.trim() === '') {
            setError(destinoInput, errorDestino, true);
            if (valid) destinoInput.focus();
            valid = false;
        } else {
            setError(destinoInput, errorDestino, false);
        }

        if (fechaInput.value.trim() === '') {
            setError(fechaInput, errorFecha, true);
            if (valid) fechaInput.focus();
            valid = false;
        } else {
            setError(fechaInput, errorFecha, false);
        }

        return valid;
    }

    [materialInput, cantidadInput, unidadInput, camionInput, destinoInput, fechaInput].forEach((input) => {
        if (!input) return;
        input.addEventListener('input', () => {
            ...
            setError(input, map[input.id], false);
        });
    ...
    if (cargaForm) {
        cargaForm.addEventListener('submit', function (e) {
            if (!validarFormulario()) {
                e.preventDefault();
                showToast(
                    'Formulario incompleto',
                    'Revisa los campos obligatorios antes de guardar la carga.',
                    'warning',
                    3200
                );
                return;
            ...
            showToast(
                'Validación correcta',
                'Se guardará la nueva carga correctamente.',
                'success',
                1800
            );
        });
    ...
    window.addEventListener('load', () => {
        showToast(
            'Formulario listo',
            'Completa los datos de la carga para registrar un nuevo movimiento logístico.',
            'info',
            3200
        );
    });
