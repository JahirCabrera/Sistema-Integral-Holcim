...
<head>
    ...
    <title>Holcim · Nuevo Contacto</title>
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Agrega un nuevo contacto al directorio operativo con una interfaz moderna y consistente con el resto del sistema.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    ...
                    <div class="value">Directorio</div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Captura los datos del contacto para integrarlo al módulo de directorio y facilitar el seguimiento operativo.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value">Contacto</div>
                <div class="hero-sub">Captura nombre, empresa, tipo, teléfono, correo y dirección para integrarlo al directorio del sistema.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Campo crítico</div>
                <div class="hero-value">Nombre</div>
                <div class="hero-sub">Dato principal para identificar rápidamente al contacto dentro del directorio.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Clasificación</div>
                <div class="hero-value">Tipo</div>
                <div class="hero-sub">Permite distinguir clientes, proveedores, transportistas y contratistas.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Cobertura</div>
                <div class="hero-value">Directorio</div>
                <div class="hero-sub">La información capturada formará parte del módulo de contactos del sistema.</div>
            </div>
        </section>
        ...
        <div class="breadcrumb">
            ...
            <a href="listar.php"><i class="fas fa-address-book"></i> Contactos</a>
            <span class="separator"><i class="fas fa-chevron-right"></i></span>
            <span><i class="fas fa-plus"></i> Nuevo contacto</span>
        </div>
        ...
        <div class="info-banner">
            ...
            <div>
                <div class="info-title">Registro de contacto</div>
                <div class="info-text">Completa la información principal para integrar un nuevo contacto al directorio operativo.</div>
            </div>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Campo principal para la identificación del contacto.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Cliente, Proveedor, Transportista o Contratista.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-phone"></i></div>
                    <div class="kpi-badge">Contacto</div>
                </div>
                <div class="kpi-label">Canales</div>
                <div class="kpi-value">2</div>
                <div class="kpi-foot">Teléfono y correo para seguimiento directo.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-building"></i></div>
                    <div class="kpi-badge">Directorio</div>
                </div>
                <div class="kpi-label">Registro</div>
                <div class="kpi-value">Activo</div>
                <div class="kpi-foot">La información quedará integrada al módulo de contactos.</div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Completa los campos obligatorios y opcionales para guardar el nuevo contacto.</p>
                </div>
            </div>

            <div class="form-panel">
                <form method="POST" id="contactoForm" novalidate>
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="empresa" name="empresa" placeholder="Ej: Constructora ABC">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="email" id="correo" name="correo" placeholder="Ej: contacto@empresa.com">
                            </div>
                            <div class="field-error" id="error-correo">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group col-full">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="direccion" name="direccion" placeholder="Ej: Av. Reforma 123, CDMX">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    if (correoInput) {
        correoInput.addEventListener('input', function () {
            setError(this, errorCorreo, false);
        });
    }
    ...
    function validarFormulario() {
        ...
        if (!correoValido(correoInput.value)) {
            setError(correoInput, errorCorreo, true);
            if (valido) correoInput.focus();
            valido = false;
        } else {
            setError(correoInput, errorCorreo, false);
        }
        ...
        contactoForm.addEventListener('submit', function (e) {
            if (!validarFormulario()) {
                ...
                showToast(
                    ...
                    'Revisa los campos obligatorios antes de guardar el contacto.',
                    'warning',
                    3200
                );
                return;
            ...
            showToast(
                'Validación correcta',
                'Se guardará el nuevo contacto correctamente.',
                'success',
                1800
            );
        });
    ...
    window.addEventListener('load', () => {
        showToast(
            'Formulario listo',
            'Completa los datos del contacto para registrar un nuevo elemento en el directorio.',
            'info',
            3200
        );
    });
