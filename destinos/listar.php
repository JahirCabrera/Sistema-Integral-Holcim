...
try {
    $sql = "SELECT * FROM destinos WHERE activo = 1 ORDER BY nombre ASC";
    $stmt = $pdo->query($sql);
    $destinos = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    $error_carga = true;
    $mensaje = 'No fue posible cargar los destinos.';
    $tipo_mensaje = 'danger';
}
...
foreach ($destinos as $row) {
    if (!empty($row['telefono'])) $conTelefono++;
    if (!empty($row['contacto'])) $conContacto++;
    if (!empty($row['direccion'])) $conDireccion++;
}
...
if (isset($_GET['msg'])) {
    switch ($_GET['msg']) {
        case 'success':
            ...
            break;
        case 'created':
            $mensaje = 'Destino registrado exitosamente.';
            $tipo_mensaje = 'success';
            break;
        case 'updated':
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Gestiona obras, clientes y puntos de entrega desde una vista optimizada para escritorio y operación móvil.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    ...
                    <div class="value"><?php echo $total_destinos; ?></div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Administra los destinos activos del sistema, consulta información logística y accede rápidamente a edición o eliminación.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value"><?php echo $total_destinos; ?></div>
                <div class="hero-sub">Destinos activos disponibles actualmente en el sistema.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Con teléfono</div>
                <div class="hero-value"><?php echo $conTelefono; ?></div>
                <div class="hero-sub">Destinos con contacto telefónico registrado.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Con contacto</div>
                <div class="hero-value"><?php echo $conContacto; ?></div>
                <div class="hero-sub">Registros con responsable o persona de contacto.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Cobertura dirección</div>
                <div class="hero-value"><?php echo porcentajeSeguro($conDireccion, max(1, $total_destinos)); ?>%</div>
                <div class="hero-sub">Porcentaje de destinos con dirección capturada.</div>
            </div>
        </section>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-badge">Catálogo</div>
                </div>
                <div class="kpi-label">Total de destinos</div>
                <div class="kpi-value"><?php echo $total_destinos; ?></div>
                <div class="kpi-foot">Base actual del módulo de destinos activos.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo $conTelefono; ?></div>
                <div class="kpi-foot">Facilitan coordinación operativa y seguimiento.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Con contacto</div>
                <div class="kpi-value"><?php echo $conContacto; ?></div>
                <div class="kpi-foot">Registros con persona asociada al destino.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Con dirección</div>
                <div class="kpi-value"><?php echo $conDireccion; ?></div>
                <div class="kpi-foot">Mejoran trazabilidad logística y planeación.</div>
            </div>
        </section>
        ...
        <div class="toolbar">
            <div class="search-group">
                ...
                <input
                    ...
                    id="searchInput"
                    class="search-input"
                    placeholder="Buscar por nombre, dirección, contacto o teléfono..."
                >
            </div>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Consulta, filtra y administra el catálogo operativo de destinos activos.</p>
                </div>
            </div>
            ...
            <div class="panel">
                <?php if ($total_destinos > 0): ?>
                    <div class="empty-search" id="emptySearchState">
                        ...
                        <p>No se encontraron destinos con ese criterio de búsqueda.</p>
                    </div>
                                ...
                                <tbody id="desktopTableBody">
                                    <?php foreach ($destinos as $row): ?>
                                        <?php
                                            ...
                                            $searchText = strtolower(trim($nombre . ' ' . $direccion . ' ' . $contacto . ' ' . $telefono));
                                        ?>
                                        <tr class="search-item" data-search="<?php echo htmlspecialchars($searchText); ?>">
                                            ...
                                            <td class="actions-cell">
                                                ...
                                                <button
                                                    ...
                                                    onclick="confirmarEliminar(<?php echo (int) $row['id']; ?>, '<?php echo htmlspecialchars(addslashes($nombre)); ?>')"
                                                >
                                ...
                                <div class="mobile-grid">
                                    <div class="mobile-item">
                                        ...
                                        <div class="mobile-value">
                                            <?php echo !empty($direccion) ? htmlspecialchars($direccion) : 'No registrada'; ?>
                                        </div>
                                    </div>

                                    <div class="mobile-item">
                                        <div class="mobile-label">Contacto</div>
                                        <div class="mobile-value">
                                            <?php echo !empty($contacto) ? htmlspecialchars($contacto) : 'No registrado'; ?>
                                        </div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Comienza agregando tu primer destino al catálogo operativo del sistema.</p>
...
<nav class="mobile-bottom-nav">
    ...
    <a href="../destinos/listar.php" class="active">
        <i class="fas fa-location-dot"></i>
        <span>Destinos</span>
    </a>
    <a href="../logout.php">
...
<div class="confirm-modal" id="confirmModal">
    <div class="confirm-box">
        ...
        <p id="confirmMessage">¿Estás seguro de eliminar este destino?</p>
...
<script>
    ...
    function confirmarEliminar(id, nombre) {
        ...
        if (confirmMessage) {
            confirmMessage.textContent = '¿Estás seguro de eliminar el destino "' + nombre + '"? Esta acción no se puede deshacer.';
        }
