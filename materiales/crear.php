...
<head>
    ...
    <title>Holcim · Nuevo Material</title>
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Agrega un nuevo material al inventario con una interfaz moderna y consistente con el resto del sistema.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    ...
                    <div class="value">Inventario</div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Captura los datos principales del material para integrarlo al inventario del sistema y facilitar el control operativo.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value">Material</div>
                <div class="hero-sub">Captura nombre, tipo, unidad, cantidad, estado y observaciones para integrarlo al inventario.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Dato clave</div>
                <div class="hero-value">Nombre</div>
                <div class="hero-sub">Identifica claramente el material dentro del catálogo del sistema.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Control</div>
                <div class="hero-value">Cantidad</div>
                <div class="hero-sub">Permite medir disponibilidad y detectar niveles críticos de stock.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Estado</div>
                <div class="hero-value">Inventario</div>
                <div class="hero-sub">Disponible, Bajo stock o Agotado según la condición actual del material.</div>
            </div>
        </section>
        ...
        <div class="breadcrumb">
            ...
            <a href="listar.php"><i class="fas fa-cubes"></i> Materiales</a>
            <span class="separator"><i class="fas fa-chevron-right"></i></span>
            <span><i class="fas fa-plus"></i> Nuevo material</span>
        </div>
        ...
        <div class="info-banner">
            ...
            <div>
                <div class="info-title">Registro de material</div>
                <div class="info-text">Completa la información principal para integrar un nuevo material al inventario operativo.</div>
            </div>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Campo principal para identificar el material dentro del inventario.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-layer-group"></i></div>
                    <div class="kpi-badge">Clasificación</div>
                </div>
                <div class="kpi-label">Tipo</div>
                <div class="kpi-value">10</div>
                <div class="kpi-foot">Opciones base de material contempladas en el formulario.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Define la disponibilidad operativa del material registrado.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-foot">Disponible, Bajo stock o Agotado para control visual inmediato.</div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Completa los campos obligatorios y opcionales para guardar el nuevo material.</p>
                </div>
            </div>

            <div class="form-panel">
                <form method="POST" id="materialForm" novalidate>
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-box-open left-icon"></i>
                                <input type="text" id="nombre" name="nombre" placeholder="Ej: Cemento Portland" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field-error" id="error-tipo">
                                <i class="fas fa-circle-exclamation"></i>
                                Debes seleccionar un tipo de material.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="unidad" name="unidad" placeholder="Ej: kg, ton, m3">
                            </div>
                            <div class="help-text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-cubes left-icon"></i>
                                <input type="number" id="cantidad" name="cantidad" step="0.01" min="0" placeholder="Ej: 150" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-circle-check left-icon"></i>
                        ...
                        <div class="form-group col-full">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="obs" name="obs" placeholder="Ej: Uso prioritario para producción matutina">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    if (tipoInput) {
        tipoInput.addEventListener('change', function () {
            setError(this, errorTipo, false);
        });
    }

    if (cantidadInput) {
        cantidadInput.addEventListener('input', function () {
            setError(this, errorCantidad, false);
        });
    }
    ...
    function validarFormulario() {
        ...
        if (tipoInput.value.trim() === '') {
            setError(tipoInput, errorTipo, true);
            if (valido) tipoInput.focus();
            valido = false;
        } else {
            setError(tipoInput, errorTipo, false);
        }

        if (cantidadInput.value.trim() === '' || Number(cantidadInput.value) < 0) {
            setError(cantidadInput, errorCantidad, true);
            if (valido) cantidadInput.focus();
            valido = false;
        } else {
        ...
        materialForm.addEventListener('submit', function (e) {
            if (!validarFormulario()) {
                ...
                showToast(
                    ...
                    'Revisa los campos obligatorios antes de guardar el material.',
                    'warning',
                    3200
                );
                return;
            ...
            showToast(
                'Validación correcta',
                'Se guardará el nuevo material correctamente.',
                'success',
                1800
            );
        });
    ...
    window.addEventListener('load', () => {
        showToast(
            'Formulario listo',
            'Completa los datos del material para registrar un nuevo elemento en el inventario.',
            'info',
            3200
        );
    });
