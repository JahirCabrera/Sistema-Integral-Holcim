...
<head>
    ...
    <title>Holcim · Registrar Trabajador</title>
...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <div class="menu-group">
            ...
            <a class="nav-link active" href="../trabajadores/listar.php"><i class="fas fa-users"></i> Trabajadores</a>
    ...
    <main class="content">
        <section class="mobile-hero">
            ...
            <p>Agrega un nuevo colaborador al módulo de personal con un registro interno seguro y organizado.</p>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Captura la información principal del colaborador para integrarlo al registro interno del módulo de trabajadores.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                <div class="hero-title">Registro interno</div>
                <div class="hero-value">Trabajador</div>
                <div class="hero-sub">Captura nombre, puesto, área, teléfono y estado del colaborador dentro del módulo de trabajadores.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Estado sugerido</div>
                <div class="hero-value">Activo</div>
                <div class="hero-sub">Configuración inicial recomendada al registrar un nuevo trabajador.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Campo crítico</div>
                <div class="hero-value">Nombre</div>
                <div class="hero-sub">Dato principal para identificar rápidamente al colaborador.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Registro</div>
                <div class="hero-value">Interno</div>
                <div class="hero-sub">La información del trabajador se guarda de forma interna dentro del sistema.</div>
            </div>
        </section>
        ...
        <div class="breadcrumb">
            ...
            <a href="listar.php"><i class="fas fa-users"></i> Trabajadores</a>
            <span class="separator"><i class="fas fa-chevron-right"></i></span>
            <span><i class="fas fa-user-plus"></i> Nuevo trabajador</span>
        </div>
        ...
        <div class="info-banner">
            ...
            <div>
                <div class="info-title">Registro de colaborador</div>
                <div class="info-text">Completa la información básica del trabajador. El sistema registrará los datos automáticamente dentro del módulo de personal.</div>
            </div>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-badge">Identidad</div>
                </div>
                <div class="kpi-label">Dato clave</div>
                <div class="kpi-value">Nombre</div>
                <div class="kpi-foot">Campo principal para la identificación del trabajador dentro del registro.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-briefcase"></i></div>
                    <div class="kpi-badge">Rol</div>
                </div>
                <div class="kpi-label">Puesto</div>
                <div class="kpi-value">Cargo</div>
                <div class="kpi-foot">Permite clasificar al colaborador según su función operativa.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-circle"></i></div>
                    <div class="kpi-badge">Estado</div>
                </div>
                <div class="kpi-label">Opciones</div>
                <div class="kpi-value">2</div>
                <div class="kpi-foot">Activo o Inactivo según la situación actual del trabajador.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-database"></i></div>
                    <div class="kpi-badge">Registro</div>
                </div>
                <div class="kpi-label">Sistema interno</div>
                <div class="kpi-value">Activo</div>
                <div class="kpi-foot">Los registros del personal se integran automáticamente al módulo de trabajadores.</div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Completa los campos obligatorios y opcionales para registrar correctamente al trabajador en el sistema.</p>
                </div>
            </div>

            <div class="form-panel">
                <form method="POST" id="trabajadorForm" novalidate>
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                <i class="fas fa-user-tag left-icon"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="puesto" name="puesto" placeholder="Ej: Operador de camión" required>
                            </div>
                            <div class="field-error" id="error-puesto">
                                <i class="fas fa-circle-exclamation"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="tel" id="telefono" name="telefono" placeholder="Ej: 5512345678" maxlength="15">
                            </div>
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Solo se conservarán números.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="help-text">
                                <i class="fas fa-circle-info"></i>
                                Define la situación actual del colaborador.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" id="area" name="area" placeholder="Ej: Logística / Producción">
                            </div>
                        </div>
                    </div>
        ...
        <div class="footer">
            © 2026 Holcim México · Sistema de Gestión de Cemento · Módulo de Trabajadores v3.0
        </div>
    </main>
</div>
...
<nav class="mobile-bottom-nav">
    ...
    <a href="../trabajadores/listar.php" class="active">
...
<script>
    ...
    const errorPuesto = document.getElementById('error-puesto');
    ...
    if (nombreInput) {
        nombreInput.addEventListener('input', function () {
            setError(this, errorNombre, false);
        });
    }

    if (puestoInput) {
        puestoInput.addEventListener('input', function () {
            setError(this, errorPuesto, false);
        });
    }
    ...
    function validarFormulario() {
        ...
        if (puesto === '') {
            setError(puestoInput, errorPuesto, true);
            if (valido) puestoInput.focus();
            valido = false;
        } else {
            setError(puestoInput, errorPuesto, false);
        }
    ...
    if (trabajadorForm) {
        trabajadorForm.addEventListener('submit', function (e) {
            if (!validarFormulario()) {
                e.preventDefault();
                showToast(
                    'Formulario incompleto',
                    'Revisa los campos obligatorios antes de guardar el trabajador.',
                    'warning',
                    3200
                );
                return;
            ...
            showToast(
                'Validación correcta',
                'Se guardará el nuevo trabajador correctamente en el sistema.',
                'success',
                1800
            );
        });
    ...
    window.addEventListener('load', () => {
        showToast(
            'Formulario listo',
            'Este módulo registrará al trabajador dentro del sistema.',
            'info',
            3200
        );
    });
