...
<head>
    ...
    <title>Holcim · Trabajadores</title>
...
<div class="layout">
    ...
    <main class="content">
        <section class="mobile-hero">
            <h2>Trabajadores</h2>
            <p>Consulta, busca y administra el registro de personal desde una vista moderna optimizada para escritorio y móvil.</p>
            <div class="mobile-hero-meta">
                ...
                <div class="mobile-hero-chip">
                    ...
                    <div class="value"><?php echo $total_trabajadores; ?></div>
                </div>
            </div>
        </section>
        ...
        <div class="topbar">
            <div class="welcome-box">
                ...
                <p>Administra el personal registrado, consulta su estado actual y accede rápidamente a edición o eliminación.</p>
            </div>
        ...
        <section class="hero-strip">
            <div class="hero-card main">
                ...
                <div class="hero-value"><?php echo $total_trabajadores; ?></div>
                <div class="hero-sub">Trabajadores registrados actualmente en el módulo de personal.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Activos</div>
                <div class="hero-value"><?php echo $activos; ?></div>
                <div class="hero-sub">Colaboradores disponibles o vigentes en operación.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Inactivos</div>
                <div class="hero-value"><?php echo $inactivos; ?></div>
                <div class="hero-sub">Registros marcados fuera de operación actual.</div>
            </div>

            <div class="hero-card">
                <div class="hero-title">Con teléfono</div>
                <div class="hero-value"><?php echo porcentajeSeguro($con_telefono, max(1, $total_trabajadores)); ?>%</div>
                <div class="hero-sub">Porcentaje de trabajadores con número telefónico capturado.</div>
            </div>
        </section>
        ...
        <section class="kpi-grid">
            <div class="kpi-card">
                <div class="kpi-top">
                    ...
                    <div class="kpi-badge">Personal</div>
                </div>
                <div class="kpi-label">Total registrados</div>
                <div class="kpi-value"><?php echo $total_trabajadores; ?></div>
                <div class="kpi-foot">Base actual del módulo de trabajadores.</div>
            </div>

            <div class="kpi-card">
                <div class="kpi-top">
                    <div class="kpi-icon"><i class="fas fa-user-check"></i></div>
                    <div class="kpi-badge">Disponibles</div>
                </div>
                <div class="kpi-label">Activos</div>
                <div class="kpi-value"><?php echo $activos; ?></div>
                <div class="kpi-foot">Colaboradores activos dentro del sistema.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-value"><?php echo $inactivos; ?></div>
                <div class="kpi-foot">Personal marcado como no activo actualmente.</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Con área</div>
                <div class="kpi-value"><?php echo $con_area; ?></div>
                <div class="kpi-foot">Registros con área operativa capturada.</div>
            </div>
        </section>
        ...
        <div class="toolbar">
            <div class="search-group">
                ...
                <input
                    ...
                    id="searchInput"
                    class="search-input"
                    placeholder="Buscar por nombre, apellido, puesto, área o estado..."
                >
            </div>
        ...
        <section class="section">
            <div class="section-header">
                <div>
                    ...
                    <p>Consulta el registro general del personal con acceso a edición y eliminación.</p>
                </div>
            </div>
            ...
            <div class="panel">
                <?php if ($total_trabajadores > 0): ?>
                    <div class="empty-search" id="emptySearchState">
                        ...
                        <p>No se encontraron trabajadores con ese criterio de búsqueda.</p>
                    </div>
                        ...
                        <div class="table-wrap">
                            <table class="desktop-table">
                                ...
                                <tbody id="desktopTableBody">
                                    <?php foreach ($trabajadores as $index => $row): ?>
                                        <?php
                                            ...
                                            $estado = $row['estado'] ?? '';
                                            $area = $row['area'] ?? '';
                                            $searchText = strtolower(trim($nombre . ' ' . $puesto . ' ' . $telefono . ' ' . $estado . ' ' . $area));
                                        ?>
                                        <tr class="search-item" data-search="<?php echo htmlspecialchars($searchText); ?>">
                                            ...
                                            <td class="name-cell">
                                                <span class="info-flex">
                                                    ...
                                                    <?php echo htmlspecialchars(trim($nombre) !== '' ? $nombre : 'Sin nombre'); ?>
                                                </span>
                                            </td>
                                            <td>
                                                <?php echo !empty($puesto) ? htmlspecialchars($puesto) : '<span class="muted">No definido</span>'; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo !empty($area) ? htmlspecialchars($area) : '<span class="muted">No asignada</span>'; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="actions-cell">
                                                ...
                                                <button
                                                    ...
                                                    onclick="confirmarEliminar(<?php echo $index; ?>, '<?php echo htmlspecialchars(addslashes(trim($nombre) !== '' ? $nombre : 'este trabajador')); ?>')"
                                                >
                            ...
                            <div class="mobile-card search-item" data-search="<?php echo htmlspecialchars($searchText); ?>">
                                <div class="mobile-card-top">
                                    <div class="mobile-card-title">
                                        <span class="id-badge">#<?php echo $index; ?></span>
                                        <div class="mobile-name"><?php echo htmlspecialchars(trim($nombre) !== '' ? $nombre : 'Sin nombre'); ?></div>
                                    </div>
                                    <span class="<?php echo claseEstado($estado); ?>">
                                        <i class="fas fa-circle"></i>
                                        <?php echo htmlspecialchars($estado ?: 'Sin estado'); ?>
                                ...
                                <div class="mobile-grid">
                                    <div class="mobile-item">
                                        <div class="mobile-label">Puesto</div>
                                        <div class="mobile-value">
                                            <?php echo !empty($puesto) ? htmlspecialchars($puesto) : 'No definido'; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mobile-item">
                                        <div class="mobile-label">Área</div>
                                        <div class="mobile-value">
                                            <?php echo !empty($area) ? htmlspecialchars($area) : 'No asignada'; ?>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Comienza agregando el primer colaborador al módulo de trabajadores.</p>
...
<div class="confirm-modal" id="confirmModal">
    <div class="confirm-box">
        ...
        <p id="confirmMessage">¿Estás seguro de eliminar este trabajador?</p>
...
<script>
    ...
    function confirmarEliminar(id, nombre) {
        ...
        if (confirmMessage) {
            confirmMessage.textContent = '¿Estás seguro de eliminar a "' + nombre + '"? Esta acción no se puede deshacer.';
        }
